            ...
            <div class="col-md-12">
                ...
                <div>
                    <?php if(count($vyzva->univerzity) < 2): ?>
                        ...
                        <li><a href="<?php echo e(action("UniverzityController@showUniverzita", ['id' => $vyzva->univerzity->first()->iduniverzity])); ?>"><?php echo e($vyzva->univerzity->first()->nazov); ?></a></li>
                        <br>
                    <?php else: ?>
                    ...
                    <div>
                        ...
                        <ul>
                            <?php $__currentLoopData = $spravy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sprava): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(action("SpravyController@showSprava", ['id' => $sprava->idspravy])); ?>"><?php echo e($sprava->datum); ?> / <?php echo e($sprava->user->name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <?php else: ?>
