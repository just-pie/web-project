        ...
        var groupData = [
            {
                ...
                "data": [
                    ...
                    {
                        "title": "<?php echo e($univerzita_v_krajine->krajina); ?>",
                        "id": "<?php echo e($univerzita_v_krajine->iso2); ?>", // With MapPolygonSeries.useGeodata = true, it will try and match this id, then apply the other properties as custom data
                        "color": chart.colors.getIndex(2),
                        "customData": "<?php echo e($univerzita_v_krajine->pocet); ?>"
                    },
