                ...
                <div class="widget-inner">
                    <form action="<?php echo e(url('editvyzva')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" id="nazov" name="nazov" class="form-control" required value="<?php echo e($vyzva->nazov); ?>">
                        </div>
                        <br>
                        <div>
                            <label for="popis">Krátky popis:</label>
                            <textarea name="popis" id="popis" rows="2" class="form-control" required><?php echo e($vyzva->popis); ?></textarea>
                        </div>
                        <br>
                        <div>
                            <label for="ostatneinfo">Detaily k výzve:</label>
                            <textarea name="ostatneinfo" id="ostatneinfo" rows="5" style="z-index: 2047483647;" class="form-control ostatneinfo" required><?php echo e($vyzva->ostatneinfo); ?></textarea>
                        </div>
                        <br>
                        <div>
                            <label for="dlzka">Dĺžka výzvy:</label></br>
                            <input type="text" id="dlzka" name="dlzka" class="form-control" value="<?php echo e($vyzva->dlzka); ?>" required>
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        </div>
                        <br>
                        <div>
                            <label for="platnedo">Platnosť výzvy do:</label></br>
                            <input type="date" id="platnedo" name="platnedo" class="form-control" required value="<?php echo e($vyzva->platnedo); ?>">
                        </div>
                        <br>
                        <div>
