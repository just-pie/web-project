            ...
            <div class="sidebar">
                <div class="sidebar-widget">
                    ...
                    <div class="col-md-12">
                        ...
                        <ul>
                            <li><?php echo e($sprava->vyzvy->univerzity->first()->krajiny->krajina); ?> - <?php echo e($sprava->vyzvy->univerzity->first()->mesto); ?></li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <h5>Univerzita:</h5>
                        <ul>
                            <li><?php echo e($sprava->vyzvy->univerzity->first()->nazov); ?></li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <h5>Dátum pridania správy:</h5>
                        <ul>
                            <li><?php echo e(date('d.m.Y', strtotime($sprava->datum))); ?></li>
                        </ul>
                    </div>
                    <div class="col-md-12">
