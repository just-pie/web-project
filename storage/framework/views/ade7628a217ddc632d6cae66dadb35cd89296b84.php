<?php echo $__env->make('includes.head', ['title' => 'Kontakt FSS'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<body>
    ...
    <div class="container">
        <div class="row">
            <?php $__currentLoopData = $kontakty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontakt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($kontakt->fakulta == 'Fakulta stredoeurópskych štúdií'): ?>
