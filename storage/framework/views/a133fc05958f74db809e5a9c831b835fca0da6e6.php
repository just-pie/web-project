...
// Create map instance
        var chart = am4core.create("krajiny", am4maps.MapChart);
...
// Center on the groups by default
        ...
        var groupData = [
            {
                "name": "Návštevníci z krajín sveta",
                "color": am4core.color("#3091cc"),
                "data": [
                        <?php $__currentLoopData = $navstevnici_v_krajinach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navstevnik_v_krajine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        "title": "<?php echo e($navstevnik_v_krajine->pocet); ?>",
                        "id": "<?php echo e($navstevnik_v_krajine->country_iso2); ?>" // With MapPolygonSeries.useGeodata = true, it will try and match this id, then apply the other properties as custom dat
                    },
...
// Create a series for each group, and populate the above array
        groupData.forEach(function (group) {
            ...
            hoverState.properties.fill = am4core.color("#0237cc");
