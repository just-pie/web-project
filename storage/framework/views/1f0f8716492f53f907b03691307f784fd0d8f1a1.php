<?php echo $__env->make('includes.head', ['title' => 'Kontakt FF'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<body>

<?php echo $__env->make('includes.nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

	<div class="first-widget parallax" id="ff">
		<div class="parallax-overlay">
			<div class="container pageTitle">
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<h2 class="page-title">Filozofická fakulta</h2>
					</div> <!-- /.col-md-6 -->
					<div class="col-md-6 col-sm-6 text-right">
						<span class="page-location">Domov / Kontakt/ FF</span>
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
			</div> <!-- /.container -->
	...
	<div class="container">
		<div class="row">
			<?php $__currentLoopData = $kontakty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontakt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php if($kontakt->fakulta == 'Filozofická fakulta'): ?>
										...
										<li class="list-inline-item">
											<a class="social-icon text-xs-center" target="_blank"
											   href="<?php echo e($kontakt->web); ?>">
												<i class="fa fa-globe" style="color: #d40075;"></i>
											</a>
										</li>
									<?php endif; ?>
										...
										<li class="list-inline-item">
											<a class="social-icon text-xs-center" target="_top"
											   href="mailto:<?php echo e($kontakt->email); ?>?Subject=Mobility%20študentov">
												<i class="fa fa-envelope" style="color: #d40075;"></i>
											</a>
										</li>
									<?php endif; ?>
										...
										<li class="list-inline-item">
											<a class="social-icon text-xs-center" target="_blank"
											   ...
											   data-placement="down" title="<?php echo e($kontakt->telefon); ?>">
												<i class="fa fa-phone" style="color: #d40075;"></i>
