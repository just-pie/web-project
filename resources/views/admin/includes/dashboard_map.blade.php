        ...
        var groupData = [
            {
                ...
                "data": [
                        @foreach($navstevnici_v_krajinach as $navstevnik_v_krajine)
                    {
                        "title": "{{ $navstevnik_v_krajine->pocet }}",
                        "id": "{{ $navstevnik_v_krajine->country_iso2 }}" // With MapPolygonSeries.useGeodata = true, it will try and match this id, then apply the other properties as custom dat
                    },
                        @endforeach
                ]
            }
