<footer class="site-footer">
    <div class="container">
            ...
            <div class="col-md-12">
                <nav class="footer-nav clearfix">
                    <ul class="footer-menu">
                        ...
                        <p></p><br>
                        <li><a href="https://www.ukf.sk"target="_blank" ><img id="footer-logo" src="{{ \URL::asset('images/includes/ukf-logo.png') }}" style="display: inline-block;" width="42px"
                                                              height="42px" ></a></li>
                        <li><a href="http://edu.ukf.sk/"target="_blank" ><img id="footer-logo" src="{{ \URL::asset('images/includes/edu-logo.png') }}" style="display: inline-block;" width="37px"
                                                              height="37px" ></a></li>
                        <li><a href="https://ais2.ukf.sk/"target="_blank" ><img id="footer-logo" src="{{ \URL::asset('images/includes/ais_logo.png') }}" style="display: inline-block;" width="40px"
                                                                height="40px" ></a></li>
                        <p></p>
        ...
        {{--<style>
            ...
            .cwda{cursor: pointer; font-size:16px;  text-decoration: none; padding:6px 16px; color:#fcfcfc; background-color:#101b91; border-radius:60px; border: 0px solid #7accee;}
            .cwda:hover{background-color:#a8a3c2;color:#ffffff;}
        </style>
        <div>
            <p class="cwd">
                <br>
                <a href="https://facebook.com/UKFvNitre/?locale2=sk_SK" target="_blank" class="cwda" title="Facebook">Facebook</a>
                <a href="https://www.instagram.com/ukfvnitre/" target="_blank" class="cwda" title="Instagram">Instagram</a>
